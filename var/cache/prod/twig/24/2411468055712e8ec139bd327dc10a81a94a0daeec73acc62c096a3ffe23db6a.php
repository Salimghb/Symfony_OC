...
class __TwigTemplate_2f1d67e82f7c53036fa75cdf09b5c9da14cdaafb30fe45e76f99b415604910e8 extends Twig_Template
{
...
";
        ...
        foreach ($context['_seq'] as $context["position"] => $context["e"]) {
            // line 37
            echo "    ";
            $this->loadTemplate("@Twig/Exception/traces.html.twig", "TwigBundle:Exception:exception.html.twig", 37)->display(array("exception" => $context["e"], "position" => $context["position"], "count" => (isset($context["previous_count"]) ? $context["previous_count"] : null)));
        }
        $_parent = $context['_parent'];
...
";
        ...
        <div id=\"logs\">
            ";
            // line 63
            $this->loadTemplate("@Twig/Exception/logs.html.twig", "TwigBundle:Exception:exception.html.twig", 63)->display(array("logs" => $this->getAttribute((isset($context["logger"]) ? $context["logger"] : null), "logs", array())));
            // line 64
            echo "        </div>
    </div>
";
...
";
        // line 88
        $this->loadTemplate("@Twig/Exception/traces_text.html.twig", "TwigBundle:Exception:exception.html.twig", 88)->display(array("exception" => (isset($context["exception"]) ? $context["exception"] : null)));
        // line 89
        echo "
