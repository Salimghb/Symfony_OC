...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'salim_plateforme.antispam' => 'getSalimPlateforme_AntispamService',
            'salim_plateforme.doctrine_listener.application_creation' => 'getSalimPlateforme_DoctrineListener_ApplicationCreationService',
            'salim_plateforme.email.application_mailer' => 'getSalimPlateforme_Email_ApplicationMailerService',
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('OAbi0AFBFU', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Sr2NYiyEVw', 0, 'bUQSWfXlaQV1Q7LQqR77gB', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $d->addEventListener(array(0 => 'postPersist'), $this->get('salim_plateforme.doctrine_listener.application_creation'));
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\Salim\\PlateformeBundle\\Entity'))), 'Salim\\PlateformeBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('SalimPlateformeBundle' => 'Salim\\PlateformeBundle\\Entity'));
    ...
    {
        return $this->services['property_accessor'] = new \Symfony\Component\PropertyAccess\PropertyAccessor(false, false, \Symfony\Component\PropertyAccess\PropertyAccessor::createCache('WCy4oEEExV', NULL, 'bUQSWfXlaQV1Q7LQqR77gB', $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
    }
    ...
    /**
     * Gets the 'salim_plateforme.antispam' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Salim\PlateformeBundle\AntiSpam\SalimAntiSpam A Salim\PlateformeBundle\AntiSpam\SalimAntiSpam instance
     */
    protected function getSalimPlateforme_AntispamService()
    {
        return $this->services['salim_plateforme.antispam'] = new \Salim\PlateformeBundle\AntiSpam\SalimAntiSpam($this->get('swiftmailer.mailer.default'), 'en', 5);
    }

    /**
     * Gets the 'salim_plateforme.doctrine_listener.application_creation' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Salim\PlateformeBundle\DoctrineListener\ApplicationCreationListener A Salim\PlateformeBundle\DoctrineListener\ApplicationCreationListener instance
     */
    protected function getSalimPlateforme_DoctrineListener_ApplicationCreationService()
    {
        return $this->services['salim_plateforme.doctrine_listener.application_creation'] = new \Salim\PlateformeBundle\DoctrineListener\ApplicationCreationListener($this->get('salim_plateforme.email.application_mailer'));
    }

    /**
     * Gets the 'salim_plateforme.email.application_mailer' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Salim\PlateformeBundle\Email\ApplicationMailer A Salim\PlateformeBundle\Email\ApplicationMailer instance
     */
    protected function getSalimPlateforme_Email_ApplicationMailerService()
    {
        return $this->services['salim_plateforme.email.application_mailer'] = new \Salim\PlateformeBundle\Email\ApplicationMailer($this->get('swiftmailer.mailer.default'));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Salim\\PlateformeBundle/Resources/views'), 'SalimPlateforme');
    ...
    {
        return $this->services['web_profiler.debug_toolbar'] = new \Symfony\Bundle\WebProfilerBundle\EventListener\WebDebugToolbarListener($this->get('twig'), true, 2, 'bottom', $this->get('router', ContainerInterface::NULL_ON_INVALID_REFERENCE), '^/(app(_[\\w]+)?\\.php/)?_wdt', ${($_ = isset($this->services['web_profiler.csp.handler']) ? $this->services['web_profiler.csp.handler'] : $this->getWebProfiler_Csp_HandlerService()) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('46cej4WFnb', 0, 'bUQSWfXlaQV1Q7LQqR77gB', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('58bc5baf4d29c2.26671518')), true);
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'SalimPlateformeBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\Salim\\PlateformeBundle'),
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'SalimPlateformeBundle' => 'Salim\\PlateformeBundle\\SalimPlateformeBundle',
